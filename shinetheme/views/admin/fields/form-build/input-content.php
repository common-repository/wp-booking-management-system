...
<div class="<?php echo esc_html($class) ?>">
    <div class="wpbooking-build-group ">
        ...
        <textarea data-type="content" class="item" data-name-shortcode="<?php echo esc_attr($parent) ?>" name="<?php echo esc_attr($data['name']) ?>" id="<?php echo esc_attr($data['name']) ?>"><?php echo esc_attr($data['value']) ?></textarea>
