<?php
    ...
    $post_id  = wpbooking_origin_id( $post_id, 'wpbooking_hotel_room' );
?>
    ...
    <div class="st-metabox-content-wrapper">
        <div class="form-group full-width">
            <div class="wpbooking-calendar-wrapper wb_room" data-post-id="<?php echo esc_attr( $post_id ); ?>"
                 data-post-encrypt="<?php echo wpbooking_encrypt( $post_id ); ?>"  data-table="wpbooking_availability">
                ...
                <div class="wpbooking-calendar-sidebar">
                    <div class="form-container calendar-price-df-form">
                        ...
                        <p class="form-desc"><?php echo esc_html__( 'Default price for room', 'wp-booking-management-system' ); ?></p>
                        ...
                        <div class="calendar-room-form-item full-width">
                            <h4 class="form-title"><?php echo esc_html__( 'This Property is available:', 'wp-booking-management-system' ); ?></h4>
                            <div class="calendar-input-icon mt20">
                                <label class="calendar-label wb-radio-input"><input data-style="iradio_square-orange"
                                                                                    class="wb-icheck property_available_forever"
                                                                                    type="radio"
                                                                                    name="property_available_for"
                                                                                    data-post-id="<?php echo esc_attr( $post_id ); ?>"
                                                                                    value="forever" <?php if ( $property_available_for == 'forever' or !$property_available_for ) echo 'checked' ?> > <?php echo esc_html__( 'Forever', 'wp-booking-management-system' ); ?>
                                </label>
                                <label class="calendar-label wb-radio-input"><input data-style="iradio_square-orange"
                                                                                    class="wb-icheck property_available_specific"
                                                                                    type="radio"
                                                                                    name="property_available_for"
                                                                                    data-post-id="<?php echo esc_attr( $post_id ); ?>"
                                                                                    value="specific_periods" <?php if ( $property_available_for == 'specific_periods' ) echo 'checked' ?> > <?php echo esc_html__( 'For specific periods', 'wp-booking-management-system' ); ?>
                                </label>
                            </div>
                        </div>
                    </div>
